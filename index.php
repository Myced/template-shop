<?php
 ...
 <!-- Mirrored from nouthemes.net/html/martfury/homepage-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Aug 2019 09:54:56 GMT -->
 <head>
     <meta charset="utf-8">
     ...
     <link rel="stylesheet" href="plugins/YTPlayer/dist/css/jquery.mb.YTPlayer.min.css">
     <link rel="stylesheet" href="css/market-place.css">
     <link rel="stylesheet" href="css/electronic.css">
     <link rel="stylesheet" href="css/furniture.css">
 </head>
 <body>

 <!--======================================== DEBUT BLOC 1 : TOP BANNER ===============================================-->
                 ...
                 <div class="menu--product-categories">
                     ...
                     <div class="menu__content">
                         <ul class="menu--dropdown">
                             ...
                             <li><a href="#"><i class="icon-shirt"></i> Clothing &amp; Apparel</a></li>
                             <li><a href="#"><i class="icon-lampshade"></i> Home, Garden &amp; Kitchen</a></li>
                             <li><a href="#"><i class="icon-heart-pulse"></i> Health &amp; Beauty</a></li>
                             <li><a href="#"><i class="icon-diamond2"></i> Yewelry &amp; Watches</a></li>
                             ...
                             <li><a href="#"><i class="icon-baby-bottle"></i> Babies &amp; Moms</a></li>
                             <li><a href="#"><i class="icon-baseball"></i> Sport &amp; Outdoor</a></li>
                             <li><a href="#"><i class="icon-smartphone"></i> Phones &amp; Accessories</a></li>
                             <li><a href="#"><i class="icon-book2"></i> Books &amp; Office</a></li>
                             <li><a href="#"><i class="icon-car-siren"></i> Cars &amp; Motocycles</a></li>
                             <li><a href="#"><i class="icon-wrench"></i> Home Improments</a></li>
                             <li><a href="#"><i class="icon-tag"></i> Vouchers &amp; Services</a></li>
                         </ul>
                     </div>
                 </div>
             </div>
     ...
     <nav class="navigation">
         <div class="container">
             <ul class="menu menu--furniture">
                 ...
                 <li class="menu-item-has-children has-mega-menu"><a href="shop-default.html"><i class="ion-ipad"></i> Shop</a><span class="sub-toggle"></span>
                     <div class="mega-menu">
                         <div class="mega-menu__column">
                             ...
                             <ul class="mega-menu__list">
                                 ...
                                 <li><a href="shop-sidebar-without-banner.html">Shop Without Banner</a></li>
                 ...
                 <li class="menu-item-has-children has-mega-menu"><a href="#"><i class="icon-laptop"></i> Pages</a><span class="sub-toggle"></span>
                     <div class="mega-menu">
                         <div class="mega-menu__column">
                         ...
                         <div class="mega-menu__column">
                             ...
                             <ul class="mega-menu__list">
                                 ...
                                 <li><a href="vendor-dashboard-free.html">Vendor Dashboard Free</a></li>
                                 <li><a href="vendor-dashboard-pro.html">Vendor Dashboard Pro</a></li>
                             </ul>
                         </div>
                     </div>
                 </li>
                 <li class="menu-item-has-children has-mega-menu"><a href="#"><i class="icon-headphones"></i> Blogs</a><span class="sub-toggle"></span>
                     <div class="mega-menu">
                         <div class="mega-menu__column">
 ...
 <div id="homepage-4">
         ...
         <div class="container">
             <div class="ps-section__left">
                 <div class="ps-carousel--nav-inside owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on" data-owl-animate-in="fadeIn" data-owl-animate-out="fadeOut">
                     <a href="#"><img src="img/slider/home-7/1.jpg" alt=""></a><a href="#"><img src="img/slider/home-7/2.jpg" alt=""></a><a href="#"><img src="img/slider/home-7/3.jpg" alt=""></a>
                 </div>
             </div>
     ...
     <!--======================================= DEBUT BLOCS 4, 5, 6, 7, 8, 9, 10, 11, 12 ===============================-->

     <!-------------------------------------------- DEBUT BLOC 4 : SHOP BY CATEGORIES ---------------------------------->
             ...
             <div class="ps-section__content">
                 <div class="ps-block--categories-tabs ps-tab-root">
                     ...
                     <div class="ps-block__header">
                         <div class="ps-carousel--nav ps-tab-list owl-slider" data-owl-auto="false" data-owl-speed="1000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="8" data-owl-item-xs="3" data-owl-item-sm="4" data-owl-item-md="6" data-owl-item-lg="6" data-owl-duration="500" data-owl-mousedrag="on">
                             <a class="active" href="#tab-1"><i class="icon-star"></i><span>Hot Trending</span></a>
                             <a href="#tab-2"><i class="icon-smartphone"></i><span>Cell Phones</span></a>
                             <a href="#tab-3"><i class="icon-desktop"></i><span>Computers</span></a>
                             <a href="#tab-4"><i class="icon-lampshade"></i><span>Furnitures</span></a>
                             <a href="#tab-5"><i class="icon-shirt"></i><span>T-Shirts</span></a>
                             <a href="#tab-6"><i class="icon-baby-bottle"></i><span>Baby & Mom</span></a>
                             <a href="#tab-7"><i class="icon-baseball"></i><span>Sports</span></a>
                             <a href="#tab-8"><i class="icon-book2"></i><span>Book & Office</span></a>
                             <a href="#tab-9"><i class="icon-car-siren"></i><span>Cars</span></a>
                         </div>
                     </div>
                     -->
                     <div class="ps-tabs">
         ...
         <div class="container">
             ...
             <div class="ps-section__content">
                 <div class="ps-carousel--nav">
                     ...
                     <div class="row">
                         <div class="col-xl-2 col-lg-2 col-md-2 col-sm-3 col-6 my-border">
                             <div class="ps-product ps-product--inner product-item">
     ...
     <!---------------------------------------- DEBUT BLOC 6,7, 8 : BANNER, TEL & TABLETTES, HIGH TECH -------------------------------------->
     <div class="ps-product-box">
         <div class="container">

             <!-------------------------------------------- DEBUT BLOC 6 : MIDDLE BANNER -------------------------------------------->
             <div class="ps-home-promotions"><a href="#"><img src="img/promotions/home-5/simple.jpg" alt=""></a></div>
             <!-------------------------------------------- FIN BLOC 6 : MIDDLE BANNER -------------------------------------------->

             <!-------------------------------------------- DEBUT BLOC 7 : TEL & TABLETTES ------------------------------------------------->
             <div class="ps-block--product-box">
                 <div class="ps-block__header">
                     <h3><i class="icon-laundry"></i> Téléphones et Tablettes</h3>
                     <!--
                     <ul>
             ...
             <!-------------------------------------------- FIN BLOC 7 : TEL & TABLETTES ------------------------------------------------->

             <!-------------------------------------------- DEBUT BLOC 8 : HIGH TECH ------------------------------------------------->
             <div class="ps-block--product-box">
                 <div class="ps-block__header">
                     <h3><i class="icon-shirt"></i> High Tech</h3>
                     <!--
                     <ul>
             ...
             <!-------------------------------------------- FIN BLOC 8 : HIGH TECH ------------------------------------------------->

             <!------------------------------------------- DEBUT BLOC 9 : MEILLEURES MARQUES ---------------------------------------->
             <div class="ps-best-sale-brands ps-section--furniture">
                 <div class="">
                     <div class="ps-section__content">
                         <ul class="ps-image-list">
                             <li><a href="#"><img src="img/brand/2-1.jpg" alt=""></a></li>
                             <li><a href="#"><img src="img/brand/2-2.jpg" alt=""></a></li>
                             <li><a href="#"><img src="img/brand/2-3.jpg" alt=""></a></li>
                             <li><a href="#"><img src="img/brand/2-4.jpg" alt=""></a></li>
                             <li><a href="#"><img src="img/brand/2-5.jpg" alt=""></a></li>
                             <li><a href="#"><img src="img/brand/2-6.jpg" alt=""></a></li>
                             <li><a href="#"><img src="img/brand/2-7.jpg" alt=""></a></li>
                             <li><a href="#"><img src="img/brand/2-8.jpg" alt=""></a></li>
                             <li><a href="#"><img src="img/brand/2-9.jpg" alt=""></a></li>
                             <li><a href="#"><img src="img/brand/2-10.jpg" alt=""></a></li>
                         </ul>
                     </div>
                 </div>
             </div>
             ...
             <!-------------------------------------------- DEBUT BLOC 10 : INFORMATIQUE ------------------------------------------------->
             <div class="ps-block--product-box">
                 <div class="ps-block__header">
                     <h3><i class="icon-laptop"></i> Informatique</h3>
                     <!--
                     <ul>
             ...
             <!-------------------------------------------- FIN BLOC 10 : INFORMATIQUE ------------------------------------------------->

             <!-------------------------------------------- DEBUT BLOC 11 : TELECOMS ------------------------------------------------->
             <div class="ps-block--product-box">
                 <div class="ps-block__header">
                     <h3><i class="icon-shirt"></i> Télécoms</h3>
                     <!--
                     <ul>
                         <li><a href="shop-default.html">Furniture</a></li>
                         <li><a href="shop-default.html">Home Decor</a></li>
             ...
             <!-------------------------------------------- FIN BLOC 11 : TELECOMS ------------------------------------------------->

             <!-------------------------------------------- DEBUT BLOC 12 : SOUSCRIPTION ---------------------------------------->
             ...
             <!-------------------------------------------- FIN BLOC 12 : SOUSCRIPTION ---------------------------------------->

         </div>
     </div>
     <!--====================================== FIN BLOC 6,7, 8 : BANNER, TEL & TABLETTES, HIGH TECH ===============================-->

     <!--======================================= FIN BLOCS 4, 5, 6, 7, 8, 9, 10, 11, 12 ===============================-->
 </div>
 <!--================================================== FIN BODY ================================================-->

 <!--======================================== DEBUT BLOC 13 : FOOTER ==================================================-->
         ...
         <div class="ps-footer__widgets">
             <aside class="widget widget_footer widget_contact-us">
                 ...
                 <div class="widget_content">
                     <p>Call us 24/7</p>
                     <h3>1800 97 97 69</h3>
                     <p>502 New Design Str, Melbourne, Australia <br><a href="http://nouthemes.net/cdn-cgi/l/email-protection#a6c5c9c8d2c7c5d2e6cbc7d4d2c0d3d4df88c5c9"><span class="__cf_email__" data-cfemail="4c2f2322382d2f380c212d3e382a393e35622f23">[email&#160;protected]</span></a></p>
                     <ul class="ps-list--social">
                         <li><a class="facebook" href="#"><i class="fa fa-facebook"></i></a></li>
                         <li><a class="twitter" href="#"><i class="fa fa-twitter"></i></a></li>
                         <li><a class="google-plus" href="#"><i class="fa fa-google-plus"></i></a></li>
 ...
 <!-- Mirrored from nouthemes.net/html/martfury/homepage-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Aug 2019 09:55:07 GMT -->
 </html>
